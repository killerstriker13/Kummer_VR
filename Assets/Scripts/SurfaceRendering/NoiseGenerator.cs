...
public class NoiseGenerator : MonoBehaviour
{
    ...
    public float[] GetNoise() {
        ...
        //if (muSquared == 0) { muSquared = 2.0f; }
        NoiseShader.SetFloat("_MuSquaredActual", muSquared);
    ...
    public void UpdateMuSquaredAndRender(float newMuSquared)
    {
        muSquared = newMuSquared;
        _weightsBuffer.SetData(GetNoise());
       
    }

    public void UpdateMuSquared(float newMuSquared )
    {
        muSquared = newMuSquared;
    }
}
